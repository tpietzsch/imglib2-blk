...
public class DownsampleFloatPlayground
{
	public static void main( String[] args )
	{
		...
		final CachedCellImg< FloatType, ? > downsampled = AlgoUtils.cellImg(
				blocks, new CenterFloat( downsampleInDim ), new FloatType(), downsampledDimensions, cellDimensions );
		...
		final CachedCellImg< FloatType, ? > downsampled2 = AlgoUtils.cellImg(
				blocks, new HalfPixelFloat( downsampleInDim ), new FloatType(), downsampledDimensions, cellDimensions );
