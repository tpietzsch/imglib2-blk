...
public class CopyBenchmarkDouble
{
	...
	{
		final PrimitiveBlocks< DoubleType > blocks = new NativeImgPrimitiveBlocks<>( cellImg, Extension.constant( new DoubleType( 0 ) ) );
	...
	{
		final PrimitiveBlocks< DoubleType > blocks = new NativeImgPrimitiveBlocks<>( cellImg, Extension.mirrorSingle() );
